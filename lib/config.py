# -*- coding: utf-8 -*-
VERSION = "1.5.0" #should keep up with the csfrwallet version it works with (for now at least)

DB_VERSION = 22 #a db version increment will cause csfrblockd to rebuild its database off of csfrd 

CAUGHT_UP = False #atomic state variable, set to True when csfrd AND csfrblockd are caught up
